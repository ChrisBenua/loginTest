...
/**
 * Created by Christian on 13/01/18.
 */
...
public class RegistrationActivity extends AppCompatActivity implements
    ...
    void updateStatus(FirebaseUser user) {
        if (user == null) {
            mstatusField.setText("UNREGISTERED USER");
        } else {
            mstatusField.setText("YOU REGISTERED SUCCESFULLY, YOUR EMAIL " + user.getEmail());
        }
    }
}
